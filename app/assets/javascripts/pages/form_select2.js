...
$(function() {
    ...
    var datos_contactos = gon.email_contactos
    if (typeof(datos_contactos) != "undefined") {
        instanciarMultipleTags(datos_contactos);
    }
    ...
    // Tagging support
    function instanciarMultipleTags(datos) {
        $("input.select-multiple-tags").select2({
            width: '100%',
            tags: datos
        });
